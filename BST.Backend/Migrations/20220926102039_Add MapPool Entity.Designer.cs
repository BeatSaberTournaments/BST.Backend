...
namespace BST.Backend.Migrations
{
    ...
    [Migration("20220926102039_Add MapPool Entity")]
    partial class AddMapPoolEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BST.Models.Map", b =>
                {
                    ...
                    b.HasIndex("MapId")
                        .HasDatabaseName("ix_maps_map_id");
            ...
            modelBuilder.Entity("BST.Models.Map", b =>
                {
                    b.HasOne("BST.Models.MapPool", "MapPool")
                        .WithMany("Maps")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_maps_map_pools_map_pool_id");
